...
public class Welcome implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == b1) {
			/*
			 * f1=new JFrame("hello"); f1.setSize(400,400); f1.setLayout(null);
			 * f1.setVisible(true);
			 */
		...
		if (e.getSource() == b2) {
			/*
			 * f2=new JFrame("bye"); f2.setSize(500,500); f2.setLayout(null);
			 * f2.setVisible(true);
			 */
...
class Basic implements ActionListener {
	...
	Basic(String s) {
		...
		for (c = 0; c < b.length; c++) {
			...
			b[c].setFont(new Font("Times New Roman", Font.BOLD, 25));
...
class Scientific implements ActionListener {
	...
	JButton b[], si;
	Panel p;
	String calc[] = { "C", "BS", "+/-", "+", "x^2", "sin", "sinh", "7", "8", "9", "-", "x^3", "cos", "cosh", "4", "5",
			"6", "*", "sqrt", "tan", "tanh", "1", "2", "3", "/", "1/x", "log", "bin", "0", ".", "=", "MOD", "!", "ln",
			"oct" };
	String s1, s2, op;
	double n = 0.0;
